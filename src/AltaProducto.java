...
public class AltaProducto {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String sqlUsuarios = "INSERT INTO productos (nombre, detalle,precio,cantidad)"+
            "VALUES (?, ?, ?, ?)";

            // Cargamos los datos en la tabla
            declaracion = conexion.prepareStatement(sqlUsuarios);
            declaracion.setString(1, "Nombre ");
            declaracion.setString(2, "Detalle");
            declaracion.setString(3,"144.5");
            declaracion.setString(4, "3"); // 1 es el código de Argentina
